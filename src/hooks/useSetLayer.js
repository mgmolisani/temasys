	...
	useEffect(
		() => {
			if (setLayer) {
				...
				console.warn(
					`The "${layerName}" layer has either not mounted yet or does not exist in a Stack containing this component. If you expected the "${layerName}" layer to have already mounted in a Stack containing this component, verify the correct "layerName" was used.`
				);
			}
		},
